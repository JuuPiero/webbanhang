<head>
    ...
    <link rel="manifest" href="{{ asset('assets/client/images/icons/site.html') }}">
    ...
    <link rel="stylesheet" href="{{ asset('assets/client/css/plugins/jquery.countdown.css') }}">
    <!-- Main CSS File -->
    <link rel="stylesheet" href="{{ asset('assets/client/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/client/css/skins/skin-demo-3.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/client/css/demos/demo-3.css') }}">
    @yield('head')
</head>